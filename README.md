...
## 진행과정 (자세한 내용은 [BLOG](https://umcondo.github.io/)에 정리되어 있다.)
...
## 느낀점
<p>
&nbsp;2차때 보완할 점, 리액트로의 전환 등 생각했던 것들을 모두 완성할 수 없었던 것이 아쉽다. 온전히 과업에 집중하지 못했던 것은 둘째치고, 우선순위를 정하지 못하고 세부 계획을 세우지 못했다. 또한 생각보다 구현이 어려웠거나 생각하지 못한 오류들로 인해 시간이 더 걸렸던 점도 있다. 제대로 알지못하고 구현만을 위해 쓰인 코드들도 있어 마음에 남는다. css, js 문법과 원리, 브라우저 동작원리에 대해 더 공부해야한다는 것을 느꼈다.
</p>
<p>
