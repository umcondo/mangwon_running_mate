...
const CourseData = [
  {
    ...
    courseInfo: `<b>망원에서 양화대교를 거쳐 선유도를 들렀다가 상수로 오는 코스.</b> 
    <br>사람이 제법 많은 편이다. 
    <br>중간에 양화대교를 올라가야한다. 
    <br>다리 위에서의 한강과 서울 서쪽의 경관을 즐길 수 있다.`,
  },
  {
    id: 1,
    courseName: "망원 - 홍제천",
    ...
    courseInfo: `<b>한강과 홍제천을 같이 둘러볼 수 있는 코스.</b>
    <br>달리기, 걷기를 위한 트랙이 잘 깔려져 있다. 
    <br>한강에서 홍제천으로 갈수록 사람이 적어진다. 
    <br>도착해서 산과 함께 인공폭포를 보는 묘미가 있다.
    <br>초심자라면 도중 돌아오는 것을 추천한다.`,
  },
  {
    id: 2,
    courseName: "경의선 숲길",
    ...
    courseInfo: `<b>연트럴파크라고도 불리는 경의선숲길에서 시작하는 코스.</b> 
    <br>옛 경의선 길을 이어 달리며 주변 마포의 경관을 볼 수 있다.
    <br>중간에 횡단보도를 몇개 지나야하므로 안전에 유의해야한다.
    <br>사람이 많고, 연남, 홍대 가게들과 가까워 가벼운 산책 후 구경하는 것도 추천한다.`,
  },
  {
    id: 3,
    ...
    courseInfo: `<b>당인리 발전소 앞을 들리는 코스</b>
    <br>한강에서 절두산순교지로 들어갈때 높은 계단을 올라야한다. 
    <br>합정에서 당인리발전소로 이어지는 길에는 여러 아기자기한 카페, 가게들이 있다. 
    <br>벚꽃이 피는 시기에는 다른 벚꽃축제 못지 않은 광경을 볼 수 있다.`,
  },

  {
    ...
    courseInfo: `<b>망원한강공원에서부터 마포대교까지 왕복하는 코스</b> 
    <br>마포구의 한강 길을 거의 다 경험해 볼 수 있다.
    <br>망원한강공원에서 양화대교까지는 사람이 많지만 양화대교부터는 대부분이 운동하러 나온 사람들이라 비교적 한산하다.
    <br>상수나들목 즈음에선 밤섬도 볼 수 있고, 건너편으로 국회의사당을 볼 수 있다.`,
  },
  {
    id: 5,
    ...
    courseInfo: `<b>망원한강공원에서 가양대교까지 왕복하는 코스다.</b>
    <br>마포대교 왕복코스에 비해 사람이 적다.
    <br>하지만 길은 훨씬 넓고 생태공원이 잘 갖춰져 있다.
    <br>트랙으로 가도 되지만 생태공원 흙길로 자연광경을 보며 뛰는 것도 추천한다. 
    <br>중간에 난지공원, 월드컵공원으로 갈 수 있으며, 가양대교에서 더 올라가면 행주산성으로 갈 수 있다.`,
  },
  {
    id: 6,
    courseName: "마포 한바퀴",
    ...
    courseInfo: `<b>한강, 상수, 홍대, 연남, 홍제천을 한번에 볼 수 있는 종합코스</b>
    <br>홍대 일대의 마포 이곳 저곳을 볼 수 있다.
    <br>사람 구경하기 좋다. 홍대 일대의 길들을 볼 수 있다. 
    <br>상수, 홍대 앞에서 횡단보도가 있고, 보도가 좁으므로 안전한 러닝을 요한다. `,
  },
  {
    id: 7,
    ...
    <br>인파가 드물고 길이 넓어 지인들과 함께 러닝하기 좋은 코스다.
    <br>난지도 공원 언덕을 700m쯤 달리면 하늘공원이 나타난다. 
    <br>체력이 가능하다면 하늘공원을 코스에 넣는 것도 추천한다.`,
  },
];
